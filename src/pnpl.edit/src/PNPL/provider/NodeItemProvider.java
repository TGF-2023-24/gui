...
/**
 * This is the item provider adapter for a {@link PNPL.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PNPLPackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PNPLPackage.Literals.NODE__ABSTRACT,
				 true,
				 false,
				 false,
	...
	protected void addMandatoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_mandatory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_mandatory_feature", "_UI_Node_type"),
				 PNPLPackage.Literals.NODE__MANDATORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addExcludePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_exclude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_exclude_feature", "_UI_Node_type"),
				 PNPLPackage.Literals.NODE__EXCLUDE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRequiresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_requires_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_requires_feature", "_UI_Node_type"),
				 PNPLPackage.Literals.NODE__REQUIRES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSelectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_select_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_select_feature", "_UI_Node_type"),
				 PNPLPackage.Literals.NODE__SELECT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
