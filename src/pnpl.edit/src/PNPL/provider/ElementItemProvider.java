...
/**
 * This is the item provider adapter for a {@link PNPL.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_presenceCondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_presenceCondition_feature", "_UI_Element_type"),
				 PNPLPackage.Literals.ELEMENT__PRESENCE_CONDITION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PNPLPackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
