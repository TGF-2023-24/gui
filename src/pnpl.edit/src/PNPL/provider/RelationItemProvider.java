...
/**
 * This is the item provider adapter for a {@link PNPL.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_Parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_Parent_feature", "_UI_Relation_type"),
				 PNPLPackage.Literals.RELATION__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addChildsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_Childs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_Childs_feature", "_UI_Relation_type"),
				 PNPLPackage.Literals.RELATION__CHILDS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PNPLPackage.Literals.RELATION__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		RelationType labelValue = ((Relation)object).getType();
