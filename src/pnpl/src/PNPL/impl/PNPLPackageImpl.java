...
import PNPL.ArcPT;
import PNPL.ArcTP;
import PNPL.BinaryExpression;
import PNPL.BinaryOperator;
import PNPL.Element;
 ...
 * @generated
 */
public class PNPLPackageImpl extends EPackageImpl implements PNPLPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see PNPL.PNPLPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PNPLPackageImpl() {
		super(eNS_URI, PNPLFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link PNPLPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PNPLPackage init() {
		if (isInited) return (PNPLPackage)EPackage.Registry.INSTANCE.getEPackage(PNPLPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPNPLPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PNPLPackageImpl thePNPLPackage = registeredPNPLPackage instanceof PNPLPackageImpl ? (PNPLPackageImpl)registeredPNPLPackage : new PNPLPackageImpl();

		isInited = true;

		// Create package meta-data objects
		thePNPLPackage.createPackageContents();

		// Initialize created meta-data
		thePNPLPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePNPLPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PNPLPackage.eNS_URI, thePNPLPackage);
		return thePNPLPackage;
	}
	 ...
	 */
	@Override
	public EReference getpnpl_Presencecondition() {
	 ...
	 */
	@Override
	public EAttribute getNode_Select() {
	 ...
	 */
	@Override
	public PNPLFactory getPNPLFactory() {
		return (PNPLFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(pnplEClass, PNPL__PRESENCECONDITION);
		...
		createEAttribute(nodeEClass, NODE__SELECT);
	...
	public void initializePackageContents() {
		...
		initEReference(getpnpl_Presencecondition(), this.getPresenceCondition(), null, "presencecondition", null, 1, -1, pnpl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNode_Mandatory(), ecorePackage.getEBoolean(), "mandatory", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNode_Select(), ecorePackage.getEBoolean(), "select", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(relationTypeEEnum, RelationType.AND);
